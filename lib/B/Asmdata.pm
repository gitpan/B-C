...
$insn_data{op_reflags} = [114, \&PUT_U32, "GET_U32"];
...
$insn_data{cop_line} = [128, \&PUT_U32, "GET_U32"];
$insn_data{cop_warnings} = [129, \&PUT_svindex, "GET_svindex"];
$insn_data{main_start} = [130, \&PUT_opindex, "GET_opindex"];
$insn_data{main_root} = [131, \&PUT_opindex, "GET_opindex"];
$insn_data{main_cv} = [132, \&PUT_svindex, "GET_svindex"];
$insn_data{curpad} = [133, \&PUT_svindex, "GET_svindex"];
$insn_data{push_begin} = [134, \&PUT_svindex, "GET_svindex"];
$insn_data{push_init} = [135, \&PUT_svindex, "GET_svindex"];
$insn_data{push_end} = [136, \&PUT_svindex, "GET_svindex"];
$insn_data{curstash} = [137, \&PUT_svindex, "GET_svindex"];
$insn_data{defstash} = [138, \&PUT_svindex, "GET_svindex"];
$insn_data{data} = [139, \&PUT_U8, "GET_U8"];
$insn_data{incav} = [140, \&PUT_svindex, "GET_svindex"];
$insn_data{load_glob} = [141, \&PUT_svindex, "GET_svindex"];
$insn_data{regex_padav} = [142, \&PUT_svindex, "GET_svindex"];
$insn_data{dowarn} = [143, \&PUT_U8, "GET_U8"];
$insn_data{comppad_name} = [144, \&PUT_svindex, "GET_svindex"];
$insn_data{xgv_stash} = [145, \&PUT_svindex, "GET_svindex"];
$insn_data{signal} = [146, \&PUT_strconst, "GET_strconst"];
$insn_data{formfeed} = [147, \&PUT_svindex, "GET_svindex"];
